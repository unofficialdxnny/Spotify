...
name =  Write.Input("---------------------------------Name the result file-------------------------------- : ", Colors.white_to_green, interval=0.01)
amount = Write.Input("--------------------------------How many accounts would you like to generate?---------------------------------:", Colors.blue_to_green, interval=0.01)
file_path = "main.py"
print(Colorate.Horizontal(Colors.blue_to_green, "Results will be saved in " + (name) + ".txt"))
